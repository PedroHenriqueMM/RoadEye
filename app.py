...
def detect_objects(img, net, output_layers, classes, colors):
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > 0.5 and classes[class_id] in ['car', 'truck', 'motorbike', 'bus']:  # Filtrar apenas veículos
...
# Interface Streamlit
st.title("Detecção e Rastreamento de Veículos em Vídeo")
...
if uploaded_file is not None:
    ...
    while cap.isOpened():
        ...
        for obj in tracked_objects:
            ...
            label = f"{classes[class_id]} {obj_id}"
